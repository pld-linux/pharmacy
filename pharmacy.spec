...
Summary(pl.UTF-8):   Pharmacy stara się być zgodnym z GNOME frontendem do CVS
Name:		pharmacy
Version:	0.3
Release:	5
License:	GPL
...
Pharmacy stara się być zgodnym z GNOME frontendem do CVS. Aktualnie
dostarcza ograniczony interfejs do komend CVS-u oraz "konsolę" dla
